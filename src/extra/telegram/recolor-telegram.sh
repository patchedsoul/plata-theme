...
# Colors in HEXs
l_sel_bg="`grep -e sel_bg sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_acc_fg="`grep -e acc_fg sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_acc_bg="`grep -e acc_bg sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_acc_f1="`grep -e acc_f1 sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_acc_f2="`grep -e acc_f2 sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_sgt_bg="`grep -e sgt_bg sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_sgt_f1="`grep -e sgt_f1 sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_sgt_f2="`grep -e sgt_f2 sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_dst_bg="`grep -e dst_bg sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_dst_f1="`grep -e dst_f1 sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"
l_dst_f2="`grep -e dst_f2 sass/telegram_light.css | cut -c11-17 | awk '{print toupper($0)}'`"

d_sel_bg="`grep -e sel_bg sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_acc_fg="`grep -e acc_fg sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_acc_bg="`grep -e acc_bg sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_acc_f1="`grep -e acc_f1 sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_acc_f2="`grep -e acc_f2 sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_sgt_bg="`grep -e sgt_bg sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_sgt_f1="`grep -e sgt_f1 sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_sgt_f2="`grep -e sgt_f2 sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_dst_bg="`grep -e dst_bg sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_dst_f1="`grep -e dst_f1 sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
d_dst_f2="`grep -e dst_f2 sass/telegram_dark.css | cut -c11-17 | awk '{print toupper($0)}'`"
